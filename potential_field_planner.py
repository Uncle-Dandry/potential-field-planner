...
from config import cruising_speed, dt_proc, inner_robot_radius, obstacle_radius_multiplier, Rmaxgr
...
class PotentialFieldPlanner:
  def __init__(
    self, num_robots, max_x, max_y, max_z_height,
    ...
    self.obstacle_radius_multiplier = obstacle_radius_multiplier
    self.locmin_averaging_interval = 25
    self.Rmaxgr = Rmaxgr
    self.inner_robot_radius = inner_robot_radius
